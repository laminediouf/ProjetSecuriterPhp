<nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Gestion Client<b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li><a href="liste-client.php">Liste Client</a></li>
            ...
            <li class="dropdown">
              ...
              <li><a href="ajouter-panier-client.php">Panier</a></li>
